...
int main(){
	...
	b1.print2D();
	cout<<"\nDo you want to search whether any elements exist enter the element";
	cin>>x;
        cout<<endl;
	b1.search(x);
	cout<<"\nfind the min of:";
	cin>>min;cout<<endl;
	cout<<b1.find_min(min)<<endl;
	cout<<"\nWhich element do you have to replace :";
	cin>>rep;cout<<endl;
	cout<<"\nWith what element do you have to replace :";
	cin>>curr;cout<<endl;
	b1.replace_at_parent(curr,rep);
	cout<<"\nWhich element do you have to delete :";
	cin>>dlt;cout<<endl;
	b1.deleteNode(dlt);
}
